...
export default function Test() {
  ...
  return (
    <>
      <NavbarMike />
      <section>
        <div className="container max-w-xl py-12 mx-auto space-y-24 px-25 sm:px-8 lg:px-2 lg:ml-80git lg:max-w-7xl">
          ...
          <div className="grid gap-8 sm:gap-2 md:gap-4 lg:gap-24 xl:gap-32 lg:grid-cols-2 lg:items-center">
            <div>
              <h1 className="text-sm md:text-md lg:text-xl font-bold">
                Localização: {endereco}
              </h1>
              <iframe
                className="w-64 sm:w-100 md:w-map-mdW md:h-map-mdH rounded border-4 mt-4"
