...
export default function Viatura({
    ...
    return (
        <>
            <div onClick={handleMoreClick} role="button" className={`flex flex-col outline outline-2 outline-bluemike w-full p-6 rounded-sm justify-between ${showMore ? "bg-bluemike" : "bg-white"}`}>
                <div className="flex flex-row items-center gap-4">
                    ...
                    <div className={`flex flex-col font-poppins text-left ${showMore ? "text-white" : "text-bluemike"}`}>
                        <p>Placa:</p>
                        <p className="font-bold text-xl tracking-widest uppercase">{placa}</p>
                    </div>
                </div>
                <div
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <button onClick={enterViatura} className="w-full text-bluemike font-poppins bg-white p-4 rounded-lg font-bold">
                            Entrar na viatura
                        </button>
                    </div>
                </div>
