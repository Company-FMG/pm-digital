    ...
    <>
      ...
      >
        <div className="flex justify-start place-items-center mx-auto gap-4 ">
          ...
          <div>
            <p className="text-[28px]">VT#{placa}</p>
          </div>
        ...
        <div>
          {showMore && (
            <div className="flex justify-start place-items-center gap-4 pt-2">
              <div>
                <p className="pb-2 lg:text-[20px] md:text-[18px] text-[16px]">
                  <b>Placa: </b>
                  {placa}
                </p>
                <p className="pb-2 lg:text-[20px] md:text-[18px] text-[16px]">
              ...
              <button onClick={setViatura} className="bg-white p-4 rounded-lg font-bold text-[#1A23F1] lg:text-[20px] md:text-[18px] text-[16px] ml-auto self-end">
                Atribuir Ocorrencia
              </button>
            </div>
          )}
